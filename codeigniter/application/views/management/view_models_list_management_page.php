...
<script>
    ...
    function update_models_by_brand(brand_id)
    {
        ...
        xmlhttp.onreadystatechange = function()
        {
            ...
            {
                $("#list_item_container").html(xmlhttp.responseText);
            }
        }
        var link = "<?php echo base_url(); ?>" + "index.php/management/get_list_of_models_by_brand_id?brand_id=" + brand_id + "&for_edit=1";
    ...
    function delete_item(item)
    {
        ...
        var link = "<?php echo base_url(); ?>" + "index.php/management/delete_model_by_id?model_id=" + item.attr('value');
    ...
    function update_item_name(item, new_name)
    {
        ...
        var link = "<?php echo base_url(); ?>" + "index.php/management/update_model_name_by_id?model_id=" + item.attr('value') + "&new_name=" + new_name;
        xmlhttp.open("GET", link, true);
        xmlhttp.send();
    }
    ...
    function add_new_item(new_name)
    {
        ...
        xmlhttp.onreadystatechange = function()
        {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200)
            {
                ...
                {
                    html =
                            '<div class="list_item" tag="$model->name" >' +
        ...
        var link = "<?php echo base_url(); ?>" + "index.php/management/update_models_insert_new?new_name=" + new_name + "&brand_id=" + $("#brands_drop_down_list").val();
        xmlhttp.open("GET", link, true);
        xmlhttp.send();
    }
