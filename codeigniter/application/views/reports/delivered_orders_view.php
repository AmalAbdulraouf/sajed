...
<div class="panel panel-default">
    <div class="panel-heading" style="text-align: center" >
        <h3 align="center"><?php echo lang('delivered_orders') ?></h3>
    </div>
    <div class="panel-body"  >
        <div  class="row" style="text-align: center">
			...
			<th>' . lang('repair_cost') . '</th>'
                        . '<th>' . lang('spare_parts_cost') . '</th><th>' . lang('total') . '</th>';
                        ?>
                    </tr>
                </thead>
                <tfoot>
    ...
    $("#from_date").datepicker(
            {
                ...
                onSelect: function (selected, evnt) {
                    var from;
                    from = $(this).val();
                    table.ajax.url(base_url + '/reports/delivered_orders/format/json?start_date='
                            + $("#from_date").val()
                            + '&end_date='
                            + $("#to_date").val()).load();
                }
