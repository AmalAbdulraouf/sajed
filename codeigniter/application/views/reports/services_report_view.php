...
<div class="panel panel-default">
    <div class="panel-heading" style="text-align: center" >
        <h3 align="center"><?php echo lang('services_report') ?></h3>
    </div>
            ...
            <table id="report" class="display reports" cellspacing="0" width="100%" style="direction: rtl">
                <thead>
                    <tr>
                        ...
                        <th><?php echo lang('orders_delivered_count') ?></th>
...
<script>
    ...
    var table = $('#report').DataTable({
        ...
        "bServerSide": true,
        "sAjaxSource": base_url + '/reports/services_report/format/json',
    ...
    $("#from_date").datepicker(
            {
                ...
                onSelect: function (selected, evnt) {
                    var from;
                    from = $(this).val();
                    table.ajax.url(base_url + '/reports/services_report/format/json?start_date='
                            + $("#from_date").val()
                            + '&end_date='
                            + $("#to_date").val()).load();
                }
