...
<div class="panel panel-default">
    <div class="panel-heading" style="text-align: center" >
        <h3 align="center"><?php echo lang('warranty_not_delivered') ?></h3>
    </div>
...
<script>
    ...
    var table = $('#report').DataTable({
        ...
        "bServerSide": true,
        "sAjaxSource": base_url + '/reports/warranty_not_delivered/format/json',
    ...
    $("#from_date").datepicker(
            {
                ...
                onSelect: function (selected, evnt) {
                    var from;
                    from = $(this).val();
                    table.ajax.url(base_url + '/reports/warranty_not_delivered/format/json?start_date='
                            + $("#from_date").val()
                            + '&end_date='
                            + $("#to_date").val()).load();
                }
