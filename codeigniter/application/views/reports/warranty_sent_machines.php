...
<div class="panel panel-default">
    <div class="panel-heading" style="text-align: center" >
        <h3 align="center"><?php echo lang('warranty_sent_machines') ?></h3>
    </div>
    <div class="panel-body"  >
        <div  class="row" style="text-align: center">
            <div style="margin-bottom:40px; display:inline;text-align: center">                   
...
<script>
    ...
    var table = $('#report').DataTable({
        ...
        "bServerSide": true,
        "sAjaxSource": base_url + '/reports/warranty_sent_machines/format/json',
    ...
    $("#from_date").datepicker(
            {
                ...
                onSelect: function (selected, evnt) {
                    var from;
                    from = $(this).val();
                    table.ajax.url(base_url + '/reports/warranty_sent_machines/format/json?start_date='
                            + $("#from_date").val()
                            + '&end_date='
                            + $("#to_date").val()).load();
                }
