            ...
            <div align="center" class="panel-body">
                ...
                <div  class="col-md-4">
                    ...
                    echo '<button class="report_menu_item" type="button" 
							onClick="location.href=\'' . base_url() . 'index.php/options/get_sms/send_sms_on_receive\'">' . lang('send_sms_on_receive') . '</button><br>';
                ...
                <div class="col-md-4">
                    <?php
                    echo '<button class="report_menu_item" type="button" 
							onClick="location.href=\'' . base_url() . 'index.php/options/get_sms/send_sms_on_done\'">' . lang('send_sms_on_done') . '</button><br>';
                ...
                <div class="col-md-4">
                    <?php
                    echo '<button class="report_menu_item" type="button" 
							onClick="location.href=\'' . base_url() . 'index.php/options/get_sms/send_sms_on_deliver\'">' . lang('send_sms_on_deliver') . '</button><br>';
                ...
                <div class="col-md-4">
                    <?php
                    echo '<button class="report_menu_item" type="button" 
							onClick="location.href=\'' . base_url() . 'index.php/options/get_sms/send_sms_on_cancelled\'">' . lang('send_sms_on_cancelled') . '</button><br>';
