...
/* Translated by Mohammed Yasser Moghrabiah */
	...
	$lang['update_success_message'] = 'تم تحديث بياناتك بنجاح<script type="text/javascript">
	...
	$lang['form_add'] 				= 'اضافة';
	$lang['insert_success_message'] = 'تم حفظ بياناتك بنجاح .<script type="text/javascript">
                 setTimeout(func, 2000);
		  function func() {$("#list-report-success").fadeOut("");}
		 </script>';
	$lang['form_or']				= 'أو';
